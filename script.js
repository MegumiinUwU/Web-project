...
// Maintain an index to keep track of the current image to use
let currentImageIndex = 0;

function createBookListing(book) {
    const bookListing = document.createElement('div');
    bookListing.classList.add('book-elemant');
   ...
   // titleLink.href = ' # the page you want go';
    ...
    bookListing.appendChild(titleLink);
...
// Calling of the function to display books
displayBooks();
